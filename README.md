# 🛡️ Alvin Okiya's Cybersecurity Portfolio

Welcome to my technical playground — where cloud exploits, encrypted payloads, and network defense mechanisms come to life through real-world labs and fully documented projects.

I’m **Alvin Okiya**, a cybersecurity analyst who thrives at the intersection of **threat intelligence**, **digital forensics**, and **cloud infrastructure security**. This portfolio is the culmination of applied research, certifications, sleepless lab simulations, and a relentless passion to secure digital environments.

Explore each lab as a standalone case study — with visuals, code, documentation, and guided walkthroughs designed to echo real-world analyst workflows.

---

## 🚀 Technical Arsenal

- 🔍 **Vulnerability Exploitation**: Shell uploads, SQLi, XSS, login bypasses  
- 🧠 **Threat Intelligence**: Beaconing behavior, reverse shells, C2 analysis  
- 🧰 **SIEM & Endpoint Visibility**: Wazuh, Sysmon, rule tuning, alert pipelines  
- 🕵️‍♂️ **Packet & Protocol Analysis**: Wireshark, ARP spoofing, traffic mapping  
- ☁️ **Cloud Security Engineering**: Azure Firewall, AWS IAM Rollback, NSG/ASG mastery  
- 🔐 **Data Encryption & Secure Storage**: Azure Key Vault, Always Encrypted  
- 📡 **Infrastructure Hardening**: VPN tunnels, switch lockdown, VLAN segmentation  
- 🧪 **Offensive Simulations**: DVWA, HTB Academy, console app abuse & exploit trails  

---

## 📂 Featured Projects

Click into any lab for full walkthroughs, screenshots, and markdown-rich documentation:
...
- [🐞 Vulnerable_Lambda_Exploitation](/Vulnerable_Lambda_Exploitation/README.md)
- [🕵️‍♂️ Devsecops_Defender](/Devsecops_Defender/README.md)
- [🧱 AzureDefender_Monitor_Sentinel_JIT](/AzureDefender_Monitor_Sentinel_JIT/README.md)
